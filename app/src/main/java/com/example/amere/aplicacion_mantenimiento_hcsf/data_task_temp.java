...
public class data_task_temp implements Serializable {
...
//Añadir nuevos campos requeridos
    public data_task_temp() {

    }
//Añadir nuevos campos requeridos tambien en el constructor
    public data_task_temp(String id, String tipo, String ubicacion, String piso, String area,
...
//agregar getter a los nuevos campos
    ...
    public static Comparator<data_task_temp> orden_tipo=new Comparator<data_task_temp>() {
        @Override
        public int compare(data_task_temp o1, data_task_temp o2) {
